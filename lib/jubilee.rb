require File.join(File.dirname(__FILE__), "../jars/jackson-core-2.4.0.jar")
require File.join(File.dirname(__FILE__), "../jars/jackson-databind-2.4.0.jar")
require File.join(File.dirname(__FILE__), "../jars/jackson-annotations-2.4.0.jar")
require File.join(File.dirname(__FILE__), "../jars/hazelcast-3.2.5.jar")
...
require File.join(File.dirname(__FILE__), "../jars/netty-all-4.0.23.Final.jar")
